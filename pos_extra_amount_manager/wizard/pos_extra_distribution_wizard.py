# -*- coding: utf-8 -*-
"""
Wizard: Distribute extra amount (percent or fixed)
"""
...
class PosExtraDistributionWizard(models.TransientModel):
    ...
    cogs_commission_account_id = fields.Many2one('account.account', required=True, domain="[('account_type', '=', 'cogs')]")  # CHANGED
    ...
    def default_get(self, fields_list):
        ...
        account_id = self.env['ir.config_parameter'].sudo().get_param('pos_extra_amount_manager.cogs_commission_account_id')
